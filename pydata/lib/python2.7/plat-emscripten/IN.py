...
_SYS_SYSMACROS_H_OUTER = 1
_SYS_SYSMACROS_H = 1

# Included from bits/sysmacros.h
_BITS_SYSMACROS_H = 1
def __SYSMACROS_DECLARE_MAJOR(DECL_TEMPL): return \

def __SYSMACROS_DEFINE_MAJOR(DECL_TEMPL): return \

def __SYSMACROS_DECLARE_MINOR(DECL_TEMPL): return \

def __SYSMACROS_DEFINE_MINOR(DECL_TEMPL): return \

def __SYSMACROS_DECLARE_MAKEDEV(DECL_TEMPL): return \

def __SYSMACROS_DEFINE_MAKEDEV(DECL_TEMPL): return \

def __SYSMACROS_DM(symbol): return __SYSMACROS_DM1 \
